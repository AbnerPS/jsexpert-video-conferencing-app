class PeerBuilder {
    ...
    // adicionar o comportamento dos eventos de call tambemm para quem ligar
    ...
    _preparePeerInstanceFunction(peerModule) {
        ...
        PeerCustomModule.prototype.call = function(id, stream) {
            ...
            // interceptamos o call e adicionamos todos os eventos da chamada para quem liga tbm
